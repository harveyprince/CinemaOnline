						...
						<table class="table">
							...
							<tbody>
								...
								<tr class="success">
									...
									<th class="beginTime" date-time='<s:property value="#plan.beginTtime"/>' data-toggle="tooltip" title='<s:property value="#plan.beginTtime"/>'><s:property value="#plan.begindft"/></th>
									<th class="endTime" date-time='<s:property value="#plan.endTtime"/>' data-toggle="tooltip" title='<s:property value="#plan.endTtime"/>'><s:property value="#plan.enddft"/></th>
				...
				<div class="modal-body">
					...
					<div class="pane-wrapper slide clearfix">
						...
						<div class="modal-tab-page">
							...
							<div class="vip-box account-box">
								<div class="row-line">
									<div class="row-label">vipNo:</div>
									<div class="span3 row-content">
										<input class="form-control vip-no-input" type="text" placeholder="id" />
									</div>
								</div> 
								<div class="row-line">
									<div class="row-label">vipPassword:</div>
									<div class="span3 row-content">
...
<script src="./Public/js/server/serverTicket.js"></script>
</html>